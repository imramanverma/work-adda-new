...
async function main() {
  ...
  const employersData = [
    {
      ...
      phone: "+919811100001",
      businessName: "Punjab Logistics & Quick配送",
      businessType: "Logistics & Delivery",
      description: "Fast-growing hyperlocal parcel and e-commerce distribution hub serving Chandigarh Tricity.",
      address: "Plot 42, Industrial Area Phase 1",
      location: "Chandigarh",
      latitude: 30.7063,
      longitude: 76.8015,
      website: "https://punjablogistics.example.com",
      rating: 4.8,
    },
    {
      name: "Rohan Verma",
      ...
      address: "SCO 14-15, Model Town Market",
      location: "Ludhiana",
      latitude: 30.892,
      longitude: 75.8273,
      rating: 4.6,
    },
    {
      ...
      description: "Specializing in royal Punjabi weddings, corporate conferences, and cultural festivals.",
      address: "Mall Road, Near Fountain Chowk",
      location: "Amritsar",
      latitude: 31.634,
      longitude: 74.8723,
      rating: 4.9,
    },
    {
      ...
      description: "Cozy European-style cafe and live sourdough bakery in Phase 7 Mohali.",
      address: "SCF 28, Phase 7",
      location: "Mohali",
      latitude: 30.7046,
      longitude: 76.7179,
      rating: 4.7,
    },
    {
      ...
      address: "Chaura Bazar Commercial Complex",
      location: "Ludhiana",
      latitude: 30.9126,
      longitude: 75.8541,
      rating: 4.4,
    },
    {
      ...
      address: "Bestech Business Towers, Sector 66",
      location: "Mohali",
      latitude: 30.6756,
      longitude: 76.7412,
      rating: 4.8,
    },
    {
      ...
      address: "Hall Bazaar Outer Ring",
      location: "Amritsar",
      latitude: 31.628,
      longitude: 74.879,
      rating: 4.5,
    ...
    },
    {
      ...
      address: "GT Road Industrial Corridor",
      location: "Jalandhar",
      latitude: 31.2855,
      longitude: 75.6174,
      rating: 4.3,
    ...
    },
    {
      ...
      address: "Sector 34 Commercial Area",
      location: "Chandigarh",
      latitude: 30.723,
      longitude: 76.768,
      rating: 4.8,
  ...
  const workersData = [
    ...
    },
    {
      ...
      experience: "3 years in Ludhiana garment wholesale depot.",
    ...
    },
    {
      ...
      phone: "+919822200015",
      bio: "Customer success and telecalling executive. Fluent in Punjabi, Hindi, and English.",
    ...
    },
    {
      ...
      experience: "6 years master carpenter assistant in Punjab.",
      education: "High School",
    ...
    },
    {
      ...
      experience: "Styled stalls at Chandigarh Club and Sector 17 trade fairs.",
  ...
  const jobsData = [
    {
      employerIndex: 0, // Punjab Logistics (Chandigarh)
      title: "Hyperlocal Delivery Assistant (Tricity Hub)",
    ...
    {
      employerIndex: 0, // Punjab Logistics
    ...
    {
      employerIndex: 2, // Virasat Events (Amritsar)
      title: "Royal Wedding Event Setup Crew & Ushers",
      description: "Support upcoming 3-day royal Punjabi wedding at heritage resort. Coordinate guest welcome ushering, flower petal setup, and buffet floor assistance.",
      category: "Events",
    ...
    },
    {
      ...
      jobType: "PART_TIME",
      location: "SCF 28, Phase 7, Mohali",
      latitude: 30.7046,
      longitude: 76.7179,
      payAmount: 650,
      payType: "DAILY",
    ...
    },
    {
      ...
      description: "Create eye-catching Canva graphics, write Punjabi & English short captions, and schedule weekly promotional reels for local clients.",
      category: "Marketing",
    ...
    {
      employerIndex: 6, // Mehra Textiles (Amritsar)
    ...
    },
    {
      ...
      description: "Assist Punjabi wedding florist with stringing marigold garlands and setting up stage backdrop floral arches.",
      category: "Events",
      requiredSkills: ["Event Setup & Ushering", "General Physical Labour"],
      jobType: "GIG",
      location: "Mall Road, Amritsar",
  ...
  await prisma.notification.create({
    data: {
      ...
      message: `Punjab Logistics has accepted your application for 'Hyperlocal Delivery Assistant'. Work assignment has been started.`,
      type: "APPLICATION",
      isRead: false,
    },
  });
